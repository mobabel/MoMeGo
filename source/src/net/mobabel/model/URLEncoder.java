 ...
 * static methods for converting a String to the <CODE>application/x-www-form-urlencoded</CODE>
 ...
 * through "<code>Z</code>" and "<code>0</code>" through "<code>9</code>"
 * remain the same.
 * <li>The special characters "<code>.</code>", "<code>-</code>", "<code>*</code>",
 * and "<code>_</code>" remain the same.
...
public class URLEncoder {
	...
	static {
		...
		dontNeedEncoding[' '] = true; // encoding a space to a + is done in
										// the encode() method
